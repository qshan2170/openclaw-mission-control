    ...
    <div className="mt-4 space-y-2">
      <div className="relative">
        ...
        {mentionTarget && filteredMentionOptions.length > 0 ? (
          <div className="absolute bottom-full left-0 z-20 mb-2 w-full overflow-hidden rounded-xl border border-slate-200 bg-white shadow-lg dark:border-slate-800 dark:bg-slate-950 dark:shadow-black/30">
            <div className="max-h-52 overflow-y-auto py-1">
              {filteredMentionOptions.map((option, index) => (
                ...
                >
                  ...
                  <span className="text-xs text-slate-400 dark:text-slate-500">mention</span>
                </button>
              ))}
            </div>
          </div>
